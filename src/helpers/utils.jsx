...
export const getInitialTheme = (themeConfig) => {
  ...
  if (
    ...
    !(localStorage.getItem('profile-theme') === null) &&
    themeConfig.themes.includes(localStorage.getItem('profile-theme'))
  ) {
    let theme = localStorage.getItem('profile-theme');
...
export const notFoundError = {
  ...
  subTitle: (
    <p>
      Please provide correct github username in <code>profile.config.js</code>.
    </p>
  ),
};
